...
| 2026-05-17 | ready to dispatch | [`plans/2026-05-17-remote-control-R5f-client-rich-rendering.md`](plans/2026-05-17-remote-control-R5f-client-rich-rendering.md) — R-5f: Android client consumes R-5e's enriched EntrySummary (markdown / images / tool_call / plan). Adds diff streaming via `get_session_entry(entry_index)` driven by `agent_session_message_appended` payload. Compose markdown rendering + inline images via Coil + expandable tool-call rows. |
