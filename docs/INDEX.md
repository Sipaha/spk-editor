...
| 2026-05-16 | ready to dispatch | [`plans/2026-05-16-remote-control-R5a-android-bootstrap.md`](plans/2026-05-16-remote-control-R5a-android-bootstrap.md) — R-5a: bootstrap `spk-editor-android-client` repo + two-module Gradle layout (`:core` JVM connection lib + `:app` Android Compose stub). `:core` implements WS+TLS+HMAC handshake + JSON-RPC client; `:app` minimal Compose surface. Verifiable without Android SDK (JDK 25 + Gradle wrapper). |
