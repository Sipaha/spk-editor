...
| 2026-05-16 | complete | [`plans/2026-05-16-remote-control-R5a-android-bootstrap.md`](plans/2026-05-16-remote-control-R5a-android-bootstrap.md) — R-5a: bootstrap `spk-editor-android-client` repo + two-module Gradle layout (`:core` JVM connection lib, 30 green tests + `:app` Android Compose stub). Sibling-repo commits `77eb966` (bootstrap) → `4e478f1` (`:cli` smoke client + six-step `LiveEditorIntegrationTest`, default :core:test still 30 PASSED, `-DincludeTags=integration` discovers the live probe). WS+TLS+HMAC + JSON-RPC client wired end-to-end; `:app` ready for SDK-equipped maintainer build. |
| 2026-05-16 | planned | [`plans/2026-05-16-remote-control-R5b-qr-scanner.md`](plans/2026-05-16-remote-control-R5b-qr-scanner.md) — R-5b: zxing-android-embedded QR scanner replaces the R-5a paste-URL stub. Awaits Android SDK. |
| 2026-05-16 | planned | [`plans/2026-05-16-remote-control-R5c-solutions-sessions-list.md`](plans/2026-05-16-remote-control-R5c-solutions-sessions-list.md) — R-5c: solutions list + sessions list via Navigation Compose + live-subscribe. Awaits R-5b. |
| 2026-05-16 | planned | [`plans/2026-05-16-remote-control-R5d-chat-streaming.md`](plans/2026-05-16-remote-control-R5d-chat-streaming.md) — R-5d: chat surface with streaming `agent_session_message_appended` + cancel-turn. Closes the R-5 arc. Awaits R-5c. |
